...
{
    public class EfOperationClaimDal : EfEntityRepositoryBase<OperationClaim, SportifMediaContext>, IOperationClaimDal
    {
        public List<ClaimDto> GetClaims(Expression<Func<ClaimDto, bool>> filter = null)
        {
            using (var context = new SportifMediaContext())
            {
